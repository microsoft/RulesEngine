...
//        /// </returns>
//        public IEnumerable<RuleExpressionParameter> CompileParamsExpression(Rule rule, IEnumerable<RuleParameter> ruleParams)
//        {

//            if (rule.LocalParams == null) return null;

//            var compiledParameters = new List<RuleExpressionParameter>();
...
//                compiledParameters.Add(new RuleExpressionParameter { Name = param.Name, Value = compiledParamDelegate, ReturnType = evaluatedParam.Type });
