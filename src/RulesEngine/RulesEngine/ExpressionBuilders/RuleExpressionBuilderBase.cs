...
namespace RulesEngine.ExpressionBuilders
{
    ...
    internal abstract class RuleExpressionBuilderBase
    {
        ...
        internal abstract Expression BuildExpressionForRuleParam(Param rule, IEnumerable<ParameterExpression> typeParamExpressions, ParameterExpression ruleInputExp);
    }
}
